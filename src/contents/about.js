...
export const connect = (
    <>
        I'm always happy to make new connections. Add me as a connection on <a href='https://www.linkedin.com/in/hanyutang-sandra/' className="underline text-sky-700 hover:text-red-700">LinkedIn</a>. 
        Or shoot me an email <a href='mailto:hanyutang.sandra@gmail.com' className="underline text-sky-700 hover:text-red-700">here</a>. 
    </>
)