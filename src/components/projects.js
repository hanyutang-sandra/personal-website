...
function Projects({setCurrentContent}) {
    ...
    return (
        <div className="grid grid-cols-2 grid-rows-2 gap-16 h-dvh -mt-40">
            <div onClick={(e) => {
                e.preventDefault();
                ...
                <div className="yelp bg-yelp-red flex flex-col items-center justify-center content-center h-full w-full rounded-xl hover:bg-rose-700">
                    ...
                    <h5 className="pt-12 text-base font-light text-center text-gray-50">Highlights from my role as Senior Software Engineer @ Yelp,<br/> focusing on iOS development.</h5>
                </div>
            </div>
            ...
            <div onClick={(e) => {
                ...
                <div className="capstone bg-otter-blue flex flex-col items-center justify-center content-center h-full w-full rounded-xl hover:bg-blue-400">
                    ...
                    <h5 className="pt-6 text-base font-light text-center text-gray-50">Final Caption Project @ CMU HCII/SCS, <br/> completed with Team Otter for HMH in 2019.</h5>
                </div>
            </div>

            <div className='col-span-2 cursor-pointer' onClick={(e) => {
                e.preventDefault();
                ...
                <div className="personal bg-violet-400 flex flex-col items-center justify-center content-center h-full w-full rounded-xl hover:bg-violet-500">
                    <SVG src="/GourdyMeSimpsons.png" width="200" height="200" alt="Yelp logo" priority={true} className="h-auto items-center justify-center content-center"></SVG>
                    <h5 className="pt-6 text-base font-light text-center text-gray-50">Hobby Projects I have worked on, <br/> iOS and Web based.</h5>
                </div>
            </div>
        </div>
    )
