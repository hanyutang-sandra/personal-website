...
function DDGPage() {
  return (
    <>
      <Head>
        <title>DuckDuckGo Projects - Hanyu Tang</title>
        <meta name="title" content="DuckDuckGo Projects - Hanyu Tang" />
        <meta name="description" content="Highlights from my role as Senior Software Engineer @ DuckDuckGo, leading development across mobile platforms." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://hanyutang-sandra.site/projects/ddg" />
        <meta property="og:title" content="DuckDuckGo Projects - Hanyu Tang" />
        <meta property="og:description" content="Highlights from my role as Senior Software Engineer @ DuckDuckGo, leading development across mobile platforms." />
