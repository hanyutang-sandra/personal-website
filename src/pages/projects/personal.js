...
function PersonalPage() {
  return (
    <>
      <Head>
        <title>Personal Projects - Hanyu Tang</title>
        <meta name="title" content="Personal Projects - Hanyu Tang" />
        <meta name="description" content="Hobby projects I have worked on - iOS and web based applications." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://hanyutang-sandra.site/projects/personal" />
        <meta property="og:title" content="Personal Projects - Hanyu Tang" />
        <meta property="og:description" content="Hobby projects I have worked on - iOS and web based applications." />
