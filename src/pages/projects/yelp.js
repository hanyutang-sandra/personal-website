...
function YelpPage() {
  return (
    <>
      <Head>
        <title>Yelp Projects - Hanyu Tang</title>
        <meta name="title" content="Yelp Projects - Hanyu Tang" />
        <meta name="description" content="Highlights from my role as Senior Software Engineer at Yelp, focusing on iOS development." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://hanyutang-sandra.site/projects/yelp" />
        <meta property="og:title" content="Yelp Projects - Hanyu Tang" />
        <meta property="og:description" content="Highlights from my role as Senior Software Engineer at Yelp, focusing on iOS development." />
